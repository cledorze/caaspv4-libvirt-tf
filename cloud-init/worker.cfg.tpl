...
${register_scc}
  ...
  - [ zypper, in, --force-resolution, --no-confirm, --force, kubernetes-kubeadm, kubernetes-kubelet, kubernetes-client, cri-o, cni-plugins, podman, kernel-default, skuba-update ]
  - [ reboot ]
